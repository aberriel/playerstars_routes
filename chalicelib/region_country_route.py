...
from chalicelib.chalice_support import private_get, private_put, private_post
...
def get_router():
    adapter = CountryRegionAdapter(Settings.REGION_COUNTRY_TABLE_NAME, Settings.DYNAMODB_URL)
