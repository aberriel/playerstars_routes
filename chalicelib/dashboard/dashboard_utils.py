...
from chalicelib.dashboard.dashboard_adapter import NullDashboardAdapter, DashboardAdapter
...
class DashboardUtils:
    ...
    def send_preduel_creation(self, preduel_id):
        message = {"event": "preduel_creation", "preduel_id": preduel_id}
        self.interactor.broadcast(json.dumps(message, default=str))

    def send_preduel_match(self, preduel_id):
        message = {"event": "preduel_match", "preduel_id": preduel_id}
        self.interactor.broadcast(json.dumps(message, default=str))
