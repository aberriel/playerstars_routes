...
class Settings:
    ...
    CHAMPIONSHIP_MUTATION_NAME_PART = config('CHAMPIONSHIP_MUTATION_NAME_PART', 'ChampionshipDev')
    ...
    CHAMPIONSHIP_TIME_TO_CHECK_VIABILITY = config('CHAMPIONSHIP_TIME_TO_CHECK_VIABILITY', 60)
    CHAMPIONShIP_AWARD_FIRST_PLACE_PERC = config('CHAMPIONSHIP_AWARD_FIRST_PLACE_PERC', 70)
    CHAMPIONSHIP_AWARD_SECOND_PLACE_PERC = config('CHAMPIONSHIP_AWARD_SECOND_PLACE_PERC', 20)
    CHAMPIONSHIP_AWARD_THIRD_PLACE_PERC = config('CHAMPIONSHIP_AWARD_THIRD_PLACE_PERC', 10)
    CHAMPIONSHIP_INTERVAL_BETWEN_LEVELS = config('CHAMPIONSHIP_INTERVAL_BETWEEN_LEVELS', 30)
